...
export default function PropertyDetails() {
  ...
  const property = {
    ...
    location: "Luanda, Talatona, Condomínio Belas",
    price: 850000000,
    description: "Desfrute do máximo conforto e sofisticação nesta magnífica residência de alto padrão. Com arquitetura clássica e acabamentos de primeira linha, esta casa oferece um estilo de vida exclusivo para você e sua família.\n\nO imóvel conta com ampla sala de estar com pé direito duplo, cozinha gourmet totalmente equipada, suítes espaçosas com closet e uma área de lazer completa com piscina e churrasqueira. Localizada em um dos condomínios mais seguros e prestigiados de Luanda.",
    features: [
      "Piscina Privativa",
      "Jardim Paisagístico",
      "Cozinha Gourmet",
    ...
    images: [
      ...
      "/attached_assets/generated_images/luxury_living_room_interior.png",
      "/attached_assets/generated_images/luxury_villa_exterior_at_dusk.png",
      "/attached_assets/generated_images/modern_luxury_apartment_building_exterior_at_sunset.png"
    ]
  };
        ...
        <div className="container mx-auto px-4 mb-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 h-[50vh] md:h-[60vh]">
            ...
            <div className="relative group overflow-hidden rounded-xl cursor-pointer">
              <img src={property.images[1]} alt="Interior View" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
            </div>
            <div className="relative group overflow-hidden rounded-xl cursor-pointer">
              <img src={property.images[2]} alt="Exterior View" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
            </div>
            <div className="relative group overflow-hidden rounded-xl cursor-pointer">
              <img src={property.images[3]} alt="Detail View" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
